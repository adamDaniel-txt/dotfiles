...
let g:vimwiki_list = [{'path': '~/sync/note/', 'syntax': 'markdown', 'ext': '.md'}]
...
require('mini.snippets').setup({
  snippets = {
    -- Automatically loads snippets based on the language file name (e.g., markdown.json)
    gen_loader.from_lang(),
  },
})

-- Integrate snippets with mini.completion so they show up in your autocomplete menu
